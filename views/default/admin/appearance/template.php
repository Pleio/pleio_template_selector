<?php
	...
	$other .= "<label>" . elgg_echo("pleio_template_selector:settings:other:sidebar_align_left") . "&nbsp;";
	$other .= elgg_view("input/dropdown", array("name" => "params[sidebar_align_left]", "value" => $plugin->sidebar_align_left, "options_values" => $yesno_options)) . "</label><br />";
